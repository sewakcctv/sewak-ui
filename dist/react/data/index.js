...
export const Table = forwardRef(function Table({ caption, className, children, ...props }, ref) { return _jsx("div", { className: "sewak-table-wrap", tabIndex: 0, role: "region", "aria-label": `${caption} table`, children: _jsxs("table", { ref: ref, className: clsx('sewak-table', className), ...props, children: [_jsx("caption", { children: caption }), children] }) }); });
