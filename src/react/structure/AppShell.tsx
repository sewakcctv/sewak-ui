...
export const AppShell = forwardRef<HTMLDivElement, AppShellProps>(function AppShell(
  { header, sidebar, children, mainId = 'sewak-main-content', skipLinkLabel = 'Skip to main content', className, ...props },
  ref,
) {
  return (
    <div {...props} ref={ref} className={clsx('sewak-app-shell', className)}>
      ...
      <div className={clsx('sewak-app-shell__body', !sidebar && 'sewak-app-shell__body--full')}>
        {sidebar}
        <main id={mainId} className="sewak-app-shell__main" tabIndex={-1}>{children}</main>
      </div>
    </div>
  );
});
